...
5. Go back to the skill Information tab and copy the appId. Paste the appId into the MinecraftHelperSpeechletRequestStreamHandler.java file for the variable supportedApplicationIds,
