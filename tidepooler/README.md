# Alexa Skills Kit SDK Sample - Tide pooler
...
5. Go back to the skill Information tab and copy the appId. Paste the appId into the TidePoolerSpeechletRequestStreamHandler.java file for the variable supportedApplicationIds,
